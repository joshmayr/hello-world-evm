...
describe("HelloWorld", function () {
  ...
  describe("Read messages", function () {
    ...
    it("GetLastMessageFromAddress should print user's last message", async function () {
        ...
        expect((await helloWorld.getLastMessageFromAddress(owner.address)).message).to.equal("Hello, World!");
        await helloWorld.sendMessage("Second message");
        expect((await helloWorld.getLastMessageFromAddress(owner.address)).message).to.equal("Second message");
    });
